    ...
    return (
        <aside
            className={`${isOpen ? "w-64" : "w-20"
                } bg-slate-900 text-white transition-all duration-300 flex flex-col z-50 relative border-r border-slate-800`}
        >
            {/* Header */}
